...
Note that the linked sparse linear solvers have different licenses, see `this page <https://minisam.readthedocs.io/install.html#sparse-solvers-license>`_ for details